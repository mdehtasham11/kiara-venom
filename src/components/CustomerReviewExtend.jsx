    ...
    <div className="bg-white py-8 px-4">
      <div className="max-w-sm mx-auto">
        ...
        <div className="space-y-6">
          ...
          <div className="border-t border-gray-200 pt-4">
            ...
            <p className="text-black text-sm leading-relaxed">
              Since I started wearing Kiara's Venom™, people seem to notice me
              more in meetings and social gatherings. It's subtle but powerful.
              I feel amazing!
            </p>
          </div>
          ...
          <div className="border-t border-gray-200 pt-4">
            ...
            <h3 className="font-bold text-black text-base mb-2">
              Finally found my signature scent
            </h3>
            <p className="text-black text-sm leading-relaxed">
              After years of searching, I finally found my signature scent.
              Kiara's Venom™ is classy, subtle, and makes me feel unique.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center justify-center space-x-2 mt-8">
          ...
          <button className="bg-gray-200 text-black font-bold text-sm w-8 h-8 rounded-full">
            3
          </button>
