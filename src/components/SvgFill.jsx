...
const SvgFill = () => {
  return (
    <svg className="waves-animated-1 text-[#600000]" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 24 150 28" preserveAspectRatio="none">
          <defs>
